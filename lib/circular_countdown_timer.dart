...
class CircularCountDownTimer extends StatefulWidget {
  ...
  CircularCountDownTimer(
      {required this.width,
        ...
        this.textStyle,
        this.key,
        this.countDownType = CountDownType.SECOND,
  ...
  @override
  CircularCountDownTimerState createState() => CircularCountDownTimerState(this.countDownType);
}
...
class CircularCountDownTimerState extends State<CircularCountDownTimer>
  ...
  CountDownType countDownType = CountDownType.SECOND;
  CircularCountDownTimerState(CountDownType countDownType){
  ...
  String _getTime(Duration duration) {
    if (this.countDownType == CountDownType.MINUT){
...
class CountDownController {
  ...
  void restart({int? duration}) {
    if (this._state.countDownType==CountDownType.MINUT){
      _state._controller!.duration =
          Duration(minutes: duration ?? _state._controller!.duration!.inMinutes);
    }else{
      _state._controller!.duration =
